...
//Draw Fuctions
void Assets::drawMainWindow(sf::RenderTarget* target)
{
    //Draw Menu Box
...
{
    //Button buttonBoot = Button("Boot", 10.f, 100.f);
    //Button buttonLoad = Button("Load", 10.f, 125.f);
    //Button buttonQuit = Button("Quit", 10.f, 150.f);
    //Button buttonIntro = Button("Intro", 10.f, 175.f);
    //Button buttonSkip = Button("Skip", 10.f, 200.f);
