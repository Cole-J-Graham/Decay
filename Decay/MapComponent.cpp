...
{
    this->mapView->createMapCore("Forest", 0, 0.390f, "Assets/Wallpapers/Forest/forestmap.jpeg",
    ...
    this->mapView->createMapCore("Castle", 1, 0.385f, "Assets/Wallpapers/Castle/castleMap.jpeg",
