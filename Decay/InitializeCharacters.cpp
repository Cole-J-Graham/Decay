...
void InitializeCharacters::initCharacters()
{
    ...
    CharacterManager::getInstance().addCharacter("SULIMAN", std::make_shared<Character>("SULIMAN", "Suliman", 100, 100, 10, 10, 0, 25.f, 960.f, 0.590f, "Assets/Sprites/suliman.png", false));
}
